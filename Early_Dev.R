...
# install_github("insightsengineering/teal")
# install_github("insightsengineering/teal.osprey")
...
header <- tags$span(
  ...
  tags$span("Teal App Demo", style = "font-size: 30px;"),
  tags$span(
    style = "display: flex; align-items: center;",
    tags$img(src = takeda_logo, alt = "Takeda logo", height = "45px",width = "100px", style = "margin-right:10px;"),
    tags$span(style = "font-size: 24px;", "Takeda @ COE")
  )
)
...
app <- init(
  ...
  modules = modules(
    tm_front_page(
      ...
      tables = list(
        `Packages used in this demo app` =
